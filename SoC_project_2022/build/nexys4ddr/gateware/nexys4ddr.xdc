...
# uart_wifi:0.tx
set_property LOC G13 [get_ports {uart_wifi_tx}]
set_property IOSTANDARD LVCMOS33 [get_ports {uart_wifi_tx}]

# uart_wifi:0.rx
set_property LOC H16 [get_ports {uart_wifi_rx}]
set_property IOSTANDARD LVCMOS33 [get_ports {uart_wifi_rx}]
